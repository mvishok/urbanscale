    ...
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6">
      ...
      >
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-slate-400 text-sm sm:text-base">Create your account to start analyzing locations</p>
        </div>
        ...
        <form onSubmit={submit} className="card grid gap-5">
          ...
          <div className="text-center text-sm text-slate-400">
            ...
            <Link className="text-indigo-400 hover:text-indigo-300 font-semibold" to="/login">
              Sign in
            </Link>
          </div>
        </form>
